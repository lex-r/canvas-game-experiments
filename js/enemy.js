...
Enemy.prototype.update = function () {
    var opposite = Game.player.pos[1] + Game.player.radius - this.pos[1];
    var adjacent = Game.player.pos[0] + Game.player.radius - this.pos[0];
    this.rotation = Math.atan2(opposite, adjacent);
    this.rotation += Math.atan2(1, 0);

    // расчет направления движения в сторону игрока
    var x = Game.player.pos[0] + Game.player.radius;
    var y = Game.player.pos[1] + Game.player.radius;
